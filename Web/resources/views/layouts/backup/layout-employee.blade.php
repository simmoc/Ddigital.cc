  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="{{ isActive($main_active, 'dashboard') }}"><a href="{{URL_DASHBOARD}}"><i class="fa fa-circle-o"></i> Dashboard</a></li>
        <li class="{{ isActive($main_active, 'applications') }} treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Tour Applications</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{ isActive($sub_active, 'add') }}"><a href="{{URL_APPLICATIONS_ADD}}"><i class="fa fa-circle-o"></i> Add</a></li>
            <li class="{{ isActive($sub_active, 'list') }}"><a href="{{URL_APPLICATIONS}}"><i class="fa fa-circle-o"></i> List</a></li>
          </ul>
        </li>
