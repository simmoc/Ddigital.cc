...
<section class="content">
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <p class="card-text"><i class="fa fa-random"></i> <?php echo e(getPhrase('categories')); ?></p>
            ...
            <div class="col-md-3 ">
             ...
             <p class="card-text"><i class="fa fa-shopping-bag" aria-hidden="true"></i> <?php echo e(getPhrase('products')); ?></p>
            ...
            <div class="col-md-3 ">
                <div class="card card-blue text-xs-center">
                    <div class="card-block">
                    <?php $total_coupons = App\Coupon::where('status','=','Active') ;?>
