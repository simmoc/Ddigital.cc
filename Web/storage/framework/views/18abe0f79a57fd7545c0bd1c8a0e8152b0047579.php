								...
								foreach( $permissions as $permission ) {
									if( isset($user_modules_permissions[$module->module_name]) ) {
										...
										if( in_array($permission, array_keys( $selected ) ) ) {
											echo '<input class="checkbox_class" type="checkbox" name="user_modules_permissions['.$module->module_name.']['.$permission.']" checked>&nbsp;' . $permission;
										} else {
											echo '<input class="checkbox_class" type="checkbox" name="user_modules_permissions['.$module->module_name.']['.$permission.']">&nbsp;' . $permission;
										}
									} else {
									echo '<input class="checkbox_class" type="checkbox" name="user_modules_permissions['.$module->module_name.']['.$permission.']">&nbsp;' . $permission;
									}
