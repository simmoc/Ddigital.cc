	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-sm-12">
				...
				<div class="kingma">
					...
					<input type="hidden" name="price_class" class="price_class" value="<?php echo e($product->price); ?>">
                      ...
                      <?php endif; ?>
                      <?php if(Auth::guest()): ?>
							<button type="submit" class="btn btn-default" name="addtocart"><?php echo e(getPhrase('ADD TO CART')); ?> </button>
						
						<button type="submit" class="btn btn-default" name="buynow"><?php echo e(getPhrase('BUY NOW')); ?> <span class="price_lable"><?php if( $product->price_type == 'default' ): ?> <?php echo e(currency( $product->price)); ?> <?php endif; ?></span></button>
					<?php endif; ?>
					<?php if(!Auth::guest()): ?>
			...
			<?php if($product->price!=0.00): ?>
				...
				<div class="add-cart">
							...
							<div>
								<label>
									...
									<span class="radio-content">
										<span class="item-content"><?php echo e($details->title . '( '.currency( $details->price ) .' )'); ?></span>
					...
					<form>
						...
						<?php if(Auth::guest()): ?>	
						<button type="button" class="btn btn-default" onclick="javascript:document.frmItem.submit();"><?php echo e(getPhrase('BUY', 'upper')); ?> <span class="price_lable">(<?php echo e(currency( $price )); ?>)</span></button>
						<?php endif; ?>
						<?php if(!Auth::guest()): ?>
						 <?php $product_owner_id  = $product->user_created;?>
					<?php if($user_id!= $product_owner_id): ?>
            ...
            <?php echo Form::open(array('url'=> URL_FREEDOWNLOAD_PRODUCT_FORM,'method'=>'POST','name'=>'contactus')); ?> 
                   <fieldset class="form-group">
                    <?php echo e(Form::label('user_name', getphrase('name'))); ?>
                        ...
                        <?php echo e(Form::text('user_name', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Jack','required'=>'true'
			...
			<?php endif; ?>	
				...
				<div class="author ">
					<h5 class="widget-title-center"><?php echo e(getPhrase( 'ABOUT AUTHOR', 'upper' )); ?></h5>
					...
					<a class="btn btn-default" href="<?php echo e(URL_DISPLAYPRODUCTS_VENDORDETAILS . $user->slug); ?>"><?php echo e(getPhrase('view_details', 'upper')); ?></a>
					
					<!--<button type="button" class="btn btn-default">SEND MESSAGE</button>-->
				</div>
				<?php if( $product->licence_of_use != ''): ?>
				<div class="license">
					<h5><?php echo e(getPhrase('LICENSE OF USE', 'upper')); ?></h5>
					<hr>
				...
				<div class="product-info">
					<h5 class="widget-title"><?php echo e(getPhrase('PRODUCT INFO', 'upper')); ?></h5>
					<ul>
				...
				<div class="technical-info">
					<h5 class="widget-title"><?php echo e(getPhrase('TECHNICAL INFO', 'upper')); ?></h5>
...
<div class="products">
	<div class="container">
		<div class="row cs-row">
			<div class="col-md-12"> 399
				<h2 class="heading "><?php echo e(getPhrase('RELATED PRODUCTS', 'upper')); ?></h2>
			</div>
			...
			<div class="col-lg-12">
				<div class="products-button">
					<a href="<?php echo e(URL_DISPLAY_PRODUCTS); ?>" class="btn btn-primary"><?php echo e(getPhrase('SEE ALL PRODUCTS', 'upper')); ?></a>
				</div>
			</div>
			<?php endif; ?>
		</div>
...
function addLicence(price,id,duration,duration_type='')
{
	...
	var currency = "<?php echo e(getSetting('currency_symbol', 'cart-settings')); ?>";
	var currency_position = "<?php echo e(getSetting('currency_position', 'cart-settings')); ?>";
