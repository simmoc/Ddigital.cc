	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">
				<p class="footer-head"> <?php echo e(getPhrase($digimenu->title)); ?></p>
			...
			?>
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">				
				<p class="footer-head"><?php echo e(getPhrase($menu_name)); ?></p>
				<ul>
			...
			<?php if( $menu4 ): ?>
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">				
				<p class="footer-head"><?php echo e(getPhrase($menu4->name)); ?></p>
