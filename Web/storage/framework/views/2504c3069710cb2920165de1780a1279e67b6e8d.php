...
<?php endif; ?>	  
	<div class="col-md-4 col-sm-6">
		...
		<div class="product <?php echo e($extra_class); ?>">
					...
					<div class="portfolio-hover-content font-reg">
						<ul class="pair-btns">
							...
							<form action="<?php echo e(URL_DISPLAY_PRODUCTS_CART); ?>" method="POST" class="side-by-side">
								...
								<?php if(Auth::guest()): ?>
								<button type="submit" class="btn btn-buy"><?php echo e(getPhrase('BUY NOW')); ?></button>
								<?php endif; ?>
								<?php if(!Auth::guest()): ?>
			...
			<div class="product-content">
				...
				<a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS.$product->slug); ?>" class="product-title" title="<?php echo e($product->name); ?>"> <?php echo e((strlen($product->name) < 24) ? $product->name : substr($product->name,0,15).'...'); ?> </a>
	...
	<?php endif; ?>
	<?php else: ?>
		<div class="col-md-4 col-sm-6"> <?php echo e(getPhrase('No Products found')); ?>
