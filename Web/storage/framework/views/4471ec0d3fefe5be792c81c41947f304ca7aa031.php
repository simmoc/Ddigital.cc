...
<?php if( $purchases->count() > 0 ): ?>
	...
	<tr>
		...
		<td class="col5"><span class="label label-success"><?php echo e(getPhrase(ucfirst($data->payment_status))); ?></span></td>
		<?php elseif($data->payment_status=='pending'): ?>
         <td class="col5"><span class="label label-info"><?php echo e(getPhrase(ucfirst($data->payment_status))); ?></span></td>
        <?php elseif($data->payment_status=='cancelled'): ?>
        <td class="col5"><span class="label label-danger"><?php echo e(getPhrase(ucfirst($data->payment_status))); ?></span></td>
        <?php endif; ?>
