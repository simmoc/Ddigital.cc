...
<section class="login-banner">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h2><?php echo e(getPhrase('CHECK OUT')); ?></h2>
			</div>
		</div>
	</div>
</section>
...
<div class="container">
	...
	<div class="col-md-8 col-sm-12">
		...
		<h2><?php echo e(getPhrase('SELECT PAYMENT METHOD')); ?></h2>		
		...
		<?php echo e(Form::text('email', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Email address' ), 
	   ...
	   <div class="form-group">
		...
		<h2><?php echo e(getPhrase('Billing Address')); ?></h2>
		<div class="form-group">
	...
	<div class="col-md-4 col-sm-12">
		  <h2><?php echo e(getPhrase('TOTAL CART', 'upper')); ?></h2>
		 <div class="total">
			<p class="fee"><?php echo e(getPhrase('PRODUCTS PRICE :', 'upper')); ?> <span><?php echo e(currency( Cart::instance('default')->subtotal() )); ?></span></p>
			<p class="fee"><?php echo e(getPhrase('Tax :', 'upper')); ?> <span><?php echo e(currency( Cart::instance('default')->tax() )); ?></span></p>
			<?php
			$licence_price = 0;
			?>
			<?php if(session()->has('licence_price')): ?>
			<p class="fee"><?php echo e(getPhrase('SUPPORT FEE :', 'upper')); ?> <span><?php echo e(currency( session()->get('licence_price') )); ?></span></p>
			...
			<p class="fee"><?php echo e(getPhrase('COUPON CODE OFF :', 'upper')); ?> <span><?php echo e(currency( session()->get('discount_amount') )); ?></span></p>
			<?php $discount_amount = session()->get('discount_amount');?>
			<?php endif; ?>
			
			<?php $cart_total = $parsed = floatval(preg_replace('/[^\d.]/', '', Cart::total()));?>
			<p class="fees"><?php echo e(getPhrase('TOTAL PRICE :', 'upper')); ?><span id="final_data"> <?php echo e(currency(($cart_total- $discount_amount )+$licence_price)); ?></span>
		...
		<input type="hidden" name="licence_price" value="<?php echo e($licence_price); ?>" id="licence_price">			
			<div class="form-group">
				 <p class="coupon"><?php echo e(getPhrase('Have Coupon Code?')); ?></p>
		...
		<div class="coupon-apply">
			<p class="coupon-data"><span class="fa fa-check"></span><?php echo e(getPhrase('Coupon Code') . $code . ' ' . currency( session()->get('discount_amount') ) . getPhrase(' applied')); ?></p>
			<p class="coupon-data1"><?php echo e(currency( session()->get('discount_amount') ) . getPhrase(' reduced from the cart')); ?></p>
...
<?php $__env->startSection('footer_scripts'); ?>
	...
	$('#frmApplycoupon').submit(function(e){
		...
		if( code == '' ) {
			$('#couponcode_message').html('<div class="alert alert-danger"><?php echo e(getPhrase("Please enter coupon code")); ?></div>');
			return false;
		}
		...
		$.ajax({
			...
			var applied_message = '<p>COUPON CODE OFF :<b>'+result.discount_amount+'</b></p>';
		   }
