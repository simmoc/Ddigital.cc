				...
				<div class="kingma">
					...
					<input type="hidden" name="price_class" class="price_class" value="<?php echo e($product->price); ?>">
                      ...
                      <?php if(Auth::guest()): ?>
						...
						<button type="submit" class="btn btn-default" name="buynow"><?php echo e(getPhrase('buy_now')); ?> <span class="price_lable"><?php if( $product->price_type == 'default' ): ?> <?php echo e(currency( $product->price)); ?> <?php endif; ?></span></button>
						<?php endif; ?>
					<?php endif; ?>
					<?php if(!Auth::guest()): ?>
