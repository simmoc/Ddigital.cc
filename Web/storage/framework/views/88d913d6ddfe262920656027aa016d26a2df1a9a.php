...
<div class="footer">
	<div class="container">
		<div class="row">
			<?php
			$digimenu = App\Menu::select(['menu_items.*'])->join('menu_items', 'menus.id', '=', 'menu_items.menu_id')->where('menus.slug', '=', 'digi-menu');
			?>
			...
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">
				<p class="footer-head"> <?php echo e($digimenu->title); ?></p>
			...
			?>
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">				
				<p class="footer-head"><?php echo e($menu_name); ?></p>
				<ul>
					...
					?>
					<li><a href="<?php echo e($url); ?>" <?php echo e($target); ?>><?php echo e($menu_item->title); ?></a></li>
			...
			?>
				...
				<ul>
					...
					?>
					<li><a href="<?php echo e($url); ?>" <?php echo e($target); ?>><span class="fa fa-caret-right"></span><?php echo e($menu_item->title); ?></a></li>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</ul>
			</div>
			<?php endif; ?>
			...
			<?php if( $menu4 ): ?>
			<div class="col-lg-3 col-md-4  col-sm-6 col-xs-12">				
				<p class="footer-head"><?php echo e($menu4->name); ?></p>
