		...
		<div class="collapse navbar-collapse" id="myNavbar1">
			...
			<?php if( $menu->count() > 0): ?>
				<ul class="nav navbar-nav navbar-right">
					<?php $__currentLoopData = $menu->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if( $menu_item->url == 'login' || $menu_item->url == 'register' ): ?>
							...
							<?php if( $menu_item->url == 'login' ): ?>
								<li <?php echo e(isActive($main_active, 'login')); ?>><a href="<?php echo e($url); ?>"><?php echo e(getPhrase('My Dashboard')); ?></a></li>							
								<li>	
                   ...
                   document.getElementById('logout-form').submit();"><?php echo e(getPhrase('LOGOUT','upper')); ?></a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="<?php echo e(isActive($main_active, 'login')); ?>"><a href="<?php echo e($url); ?>"><?php echo e(getPhrase('My Dashboard')); ?></a></li>
              ...
              <span class="badge badge-success"></span><sup><?php echo e($count = Auth::user()->newThreadsCount()); ?></sup>
				...
				<?php else: ?>
					<li class="<?php echo e(isActive($main_active, 'login')); ?>"><a href="<?php echo e(URL_USERS_LOGIN); ?>">LOGIN</a></li>
				<?php endif; ?>
