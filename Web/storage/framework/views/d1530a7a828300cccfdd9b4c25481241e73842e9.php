	...
	<div class="container">
		<div class="row">
			...
			<?php $heading = getSetting('welcome_page_heading','site_settings');
				...
				<h1 class="hero-title"> <?php echo e($heading); ?></h1>
				<p class="search-para"><?php echo e($sub_heading); ?></p>
				<div class="sign">	
						...
						<div class="input-group">
							...
							<input type="text" name="title" id="title" class="form-control" placeholder="<?php echo e(getPhrase('search_by_product')); ?>" data-toggle="dropdown" ng-model = "changedtext" ng-change="textChanged(changedtext)">								
								<ul class="dropdown-menu search-dropmenu" id="products_dropdown" ng-if = "searchtestlenght==0">
									<?php if( $searchproducts->count() > 0 ): ?>
										<?php $__currentLoopData = $searchproducts->paginate(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php
										$price = $product->price;
										...
										?>
										<li>
											  <a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS.$product->slug.'/'.$product->id); ?>">
								...
								<ul class="dropdown-menu search-dropmenu" id="products_dropdown" ng-if = "searchtestlenght>0">
										...
										<a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS); ?>{{myproduct.slug}}">
											   <div class="media-left">
											   <?php
												$product_image = DEFAULT_PRODUCT_IMAGE_THUMBNAIL;
												if( $product->image != '' && File::exists(UPLOAD_PATH_PRODUCTS_THUMBNAIL . $product->image ) ) {
												...
												?>
							<img ng-if="myproduct.image==''" src="<?php echo e(DEFAULT_PRODUCT_IMAGE_THUMBNAIL); ?>">
							<img ng-if="myproduct.image!=''" src="<?php echo e(UPLOAD_URL_PRODUCTS_THUMBNAIL); ?>{{myproduct.image}}">
									 </div>
												<div class="media-body">
													...
													?>
													 <?php echo e($currency); ?> {{myproduct.price}}
													</p>
												</div>
												</a>
										</li>
...
<?php echo $__env->make('common.search-products-script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
