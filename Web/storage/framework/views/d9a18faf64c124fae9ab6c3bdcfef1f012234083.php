...
<?php else: ?>
<?php echo Form::open(array('url' => URL_OFFERS_ADD, 'method' => 'POST', 'name'=>'formUsers ', 'files'=>'true')); ?>

<?php endif; ?>

<?php echo $__env->make('offers.form_elements', array('button_name'=> $button_name, 'record' => $record, ), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
