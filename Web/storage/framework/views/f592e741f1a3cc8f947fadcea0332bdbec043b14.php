...
<section class="login-banner">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h2><?php echo e(getPhrase('cart', 'upper')); ?></h2>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							?>
							<a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS.$item->model->slug); ?>"><img src="<?php echo e($product_image); ?>" alt="product" class="cart-image"></a></td>
               ...
               <div class="cart-button btn-left">
                <a href="<?php echo e(URL_DISPLAY_PRODUCTS); ?>" class="btn btn-primary"><?php echo e(getPhrase('Continue Shopping')); ?></a>	
                </div>		
			</div>
			<div class="col-md-4 col-sm-12">
				...
				<div class="total">
                    ...
                    <p class="fees"><?php echo e(getPhrase('TOTAL PRICE :', 'upper')); ?> <span>
				...
				<div class="cart-button">
                    <a href="<?php echo e(URL_CHECKOUT); ?>" type="submit" class="btn btn-primary"><?php echo e(getPhrase('CHECK OUT')); ?></a>
				</div>
                <?php endif; ?>
			</div>
			...
			<div class="btn-center">
				<div class="alert alert-danger">
				<?php echo e(getPhrase('Your cart is empty')); ?>
