	...
	<div class="col-md-4 col-sm-6">
		...
		<div class="product <?php echo e($extra_class); ?>">
			...
			<div class="product-content">
				...
				<a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS.$product->slug .'/'. $product->id); ?>" class="product-title" title="<?php echo e($product->name); ?>"> <?php echo e(getPhrase(strlen($product->name) < 15) ? getPhrase($product->name) : getPhrase(substr($product->name,0,15)).'...'); ?> </a>
