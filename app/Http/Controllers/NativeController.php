...
class NativeController extends Controller
{
    ...
    {         
        if( $this->isModuleEligible('Languages') != '' )
		{
			return redirect( $this->isModuleEligible('Languages') );
		}
    ...
    public function getDatatable()
    {
        ...
        ->addColumn('action', function ($records) {
             ...
             $link_data =  '<a href="'.URL_LANGUAGES_UPDATE_STRINGS.$records->slug.'" class="btn btn-primary"><i class="fa fa-info-circle" aria-hidden="true"></i>
                                                       </a> ';
          $link_data .=  ' <a href="'.URL_LANGUAGES_EDIT.'/'.$records->slug.'" class="btn btn-warning"><i class="fa fa-edit"></i> </a> ';
    ...
    {
     if( $this->isModuleEligible('Languages', array('Add')) != '' )
		{
			return redirect( $this->isModuleEligible('Languages', array('Add')) );
		}
    ...
    {
      if( $this->isModuleEligible('Languages', array('Edit')) != '' )
		{
			return redirect( $this->isModuleEligible('Languages', array('Edit')) );
		}
    ...
    public function changeDefaultLanguage($slug)
    {
      ...
      if( $this->isModuleEligible('Languages', array('Change')) != '' )
		{
			return redirect( $this->isModuleEligible('Languages', array('Change')) );
		}
    ...
    {
      if( $this->isModuleEligible('Languages', array('Delete')) != '' )
		{
			return redirect( $this->isModuleEligible('Languages', array('Delete')) );
		}
