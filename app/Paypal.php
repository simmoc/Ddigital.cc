...
class Paypal extends Model {
	...
	{
		// $settings = Settings::where('key', '=', 'paypal')->first();
	...
	public function intilizeConfig()
	{
		...
		$this->config['business'] 			= $settings->email;
		$this->config['currency_code'] 		= $settings->currency;
		$this->config['cpp_header_image'] 	= $settings->image;
		$this->config['cpp_header_image'] 	= $settings->image;
