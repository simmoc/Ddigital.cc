...
@if( $purchases->count() > 0 )
	...
	<tr>
		...
		<td class="col5"><span class="label label-success">{{ucfirst($data->payment_status)}}</span></td>
		@elseif($data->payment_status=='pending')
         <td class="col5"><span class="label label-info">{{ucfirst($data->payment_status)}}</span></td>
        @elseif($data->payment_status=='cancelled')
        <td class="col5"><span class="label label-danger">{{ucfirst($data->payment_status)}}</span></td>
        @endif
