	...
	<div class="col-md-4 col-sm-6">
		...
		<div class="product {{ $extra_class }}">
			...
			<div class="product-content">
				...
				<a href="{{ URL_DISPLAY_PRODUCTS_DETAILS.$product->slug }}" class="product-title" title="{{ $product->name }}"> {{ getPhrase(strlen($product->name) < 20) ? getPhrase($product->name) : getPhrase(substr($product->name,0,15)).'...' }} </a>
