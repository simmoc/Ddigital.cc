<div class="box-body">
	<div class="col-md-12">                
		<div class="form-group">
			...
			{{ Form::text('name', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Eg: Main Menu' ),
			'ng-model' => 'name',
			'required' => true,
		...
		?>
		<div class="form-group">
		{{ Form::label('display_dynamic_pages', getPhrase( 'Display Dynamic Pages' ) ) }}
		{{Form::select('display_dynamic_pages', $status, $selected, ['class'=>'form-control', "id"=>"display_dynamic_pages"])}}
		</div> -->
		...
		{{Form::select('status', $status,$selected,['class'=>'form-control', 'id'=>'status'])}}
		</div>		
	</div>
</div>   
<!-- /.box-body -->
