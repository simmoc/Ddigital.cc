<td>
	...
	<td>
		<input type="text" name="digi_variable_prices[<?php echo $key; ?>][name]" class="digi_variable_prices_name" value="<?php echo e($name); ?>" placeholder="<?php echo e(getPhrase('Option Name')); ?>"/>
	</td>
