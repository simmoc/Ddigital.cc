    ...
    <ul class="sidebar-menu">
        ...
        <li class="<?php echo e(isActive($main_active, 'templates')); ?> treeview">
		  ...
		  <i class="fa fa-angle-left pull-right"></i>
            ...
            <ul class="treeview-menu">
                <li class="<?php echo e(isActive($sub_active, 'list_email')); ?>"><a href="<?php echo e(URL_TEMPLATES_EMAIL); ?>"><i class="fa fa-list"></i> List</a></li> <?php if(isModuleEligible('Email_Templates', array('Add'))): ?>
                <li class="<?php echo e(isActive($sub_active, 'add')); ?>"><a href="<?php echo e(URL_TEMPLATES_ADD); ?>"><i class="fa fa-plus"></i> Add</a></li> <?php endif; ?> </ul>
