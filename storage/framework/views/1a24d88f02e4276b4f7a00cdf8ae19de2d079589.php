...
<td>
	<input type="text" name="digi_download_files[<?php echo $key; ?>][name]" class="digi_repeatable_name_field large-text" value="<?php echo e($name); ?>" placeholder="<?php echo e(getPhrase('file_name')); ?>"/>
</td>
<td>
	<select name="digi_download_files[<?php echo $key; ?>][type]" title="<?php echo e(getPhrase('please_select_type')); ?>" class="upload_type" data-index="<?php echo e($index); ?>">
		<option value="file" <?php if( $type == 'file') echo 'selected';?>><?php echo e(getPhrase('file')); ?></option>
		<option value="url" <?php if( $type == 'url') echo 'selected';?>><?php echo e(getPhrase('url')); ?></option>
	</select>
</td>
...
<td class="pricing">
	...
	<option value=""><?php echo e(getPhrase('please_select')); ?></option>
	<?php
		$options = array();
		if ( $prices ) {
