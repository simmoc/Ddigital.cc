<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="<?php echo e(isActive($main_active, 'categories')); ?> treeview">
            <a href="#"> <i class="fa fa-random"></i> <span><?php echo e(getPhrase('categories')); ?></span> <span class="pull-right-container">
		  <i class="fa fa-angle-left pull-right"></i>
		</span> </a>
        ...
        <li class="<?php echo e(isActive($main_active, 'products')); ?> treeview">
            <a href="#"> <i class="fa fa-shopping-bag" aria-hidden="true"></i> <span><?php echo e(getPhrase('products')); ?></span> <span class="pull-right-container">
		  <i class="fa fa-angle-left pull-right"></i>
		</span> </a>
            <ul class="treeview-menu">
