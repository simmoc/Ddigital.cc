	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar1">
				...
				<ul class="nav navbar-nav navbar-right">
					<?php $__currentLoopData = $menu->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if( $menu_item->url == 'login' || $menu_item->url == 'register' ): ?>
							...
							<?php else: ?>
								<?php if( $menu_item->url == 'login' ): ?>	
								<li <?php echo e(isActive($main_active, 'login')); ?>><a href="<?php echo e(URL_USERS_LOGIN); ?>"><?php echo e(getPhrase('login')); ?> </a></li>
						...
						<?php elseif( $menu_item->url == 'products-display' ): ?>
							...
							<li class="dropdown <?php echo e(isActive($main_active, 'products')); ?>">
								<a href="<?php echo e(URL_DISPLAY_PRODUCTS); ?>"><?php echo e(getPhrase('products')); ?></a>
						...
						<?php elseif( $menu_item->page_id == 'pages'): ?>
							...
							<?php if( $pages->count() > 0 ): ?>
								<li class="dropdown <?php echo e(isActive($main_active, 'pages')); ?>">
									<a href="javascript:void(0);"><?php echo e(getPhrase('pages')); ?></a>
									<ul class="dropdown-menu multi-level" role="menu">
						...
						?>
						<li <?php echo e(isActive($main_active, $menu_item->menu_active_title)); ?>><a href="<?php echo e($url); ?>" <?php echo e($target); ?>><?php echo e(getPhrase($menu_item->title)); ?></a></li>
						<?php endif; ?>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<!--for cart-->
					<li>
                   ...
                   document.getElementById('logout-form').submit();"><?php echo e(getPhrase('logout')); ?></a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<!--for home-->
				<li class="<?php echo e(isActive($main_active, 'home')); ?>"><a href="<?php echo e(PREFIX); ?>"><?php echo e(getPhrase('home')); ?></a></li>
				<!--for products-->
				<?php
				$categories = App\Category::where('status', '=', 'Active');
				?>
				...
				<li class="<?php echo e(isActive($main_active, 'about')); ?>"><a href="about.html"><?php echo e(getPhrase('about')); ?></a></li>
				<li class="<?php echo e(isActive($main_active, 'faq')); ?>"><a href="faq.html">FAQ</a></li>
				<li class="<?php echo e(isActive($main_active, 'support')); ?>"><a href="support.html"><?php echo e(getPhrase('support')); ?></a></li>
				<?php if(Auth::check()): ?>
				<?php
					$user = getUserRecord();
					$url = URL_USERS_DASHBOARD;
