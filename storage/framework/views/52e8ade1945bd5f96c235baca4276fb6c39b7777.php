               ...
               <div class="dashboard-layout">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <?php $coupons = App\Coupon::where('status','=','Active');?>
                    ...
                    <div class="col-md-3">
                     ...
                     ?>
                            ...
                            <div class="card-button">
                                <div><a href="<?php echo e(URL_VENDOR_DASHBOARD.'/purchases'); ?>" class="btn btn-primary"><?php echo e(getPhrase('view_details')); ?></a></div>
                            </div>
                        </div>
                    </div>
                ...
                <?php
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group"> <?php echo e(Form::label('last_name', getPhrase( 'Last Name' ) )); ?> <?php echo e(Form::text('last_name', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Last Name' ), 'title' => getPhrase('Last Name' ), 'ng-model'=>'last_name', 'required'=> 'true', 'ng-class'=>'{"has-error": formName.last_name.$touched && formName.last_name.$invalid}', ))); ?>

                                <div class="validation-error" ng-messages="formName.last_name.$error"> <?php echo getValidationMessage(); ?> </div>
                            </div>
                            <?php
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group"> <?php echo e(Form::label('billing_address1', getPhrase( 'Address Line1' ) )); ?> <?php echo e(Form::text('billing_address1', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Address Line1' ), 'title' => getPhrase('Address Line1' ), 'ng-model'=>'billing_address1', 'ng-class'=>'{"has-error": formName.billing_address1.$touched && formName.billing_address1.$invalid}', ))); ?> </div>
                            <div class="form-group"> <?php echo e(Form::label('billing_address2', getPhrase( 'Address Line2' ) )); ?> <?php echo e(Form::text('billing_address2', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Address Line2' ), 'title' => getPhrase('Address Line2' ), 'ng-model'=>'billing_address2', 'ng-class'=>'{"has-error": formName.billing_address2.$touched && formName.billing_address2.$invalid}', ))); ?> </div>
                            <div class="form-group"> <?php echo e(Form::label('first_name', getPhrase( 'City' ) )); ?> <?php echo e(Form::text('billing_city', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'City' ), 'title' => getPhrase('City' ), 'ng-model'=>'billing_city', 'ng-class'=>'{"has-error": formName.billing_city.$touched && formName.billing_city.$invalid}', ))); ?> </div>
                            <div class="form-group"> <?php echo e(Form::label('first_name', getPhrase( 'Zip Code' ) )); ?> <?php echo e(Form::text('billing_zip', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Zip Code' ), 'title' => getPhrase('Zip Code' ), 'ng-model'=>'billing_zip', 'ng-class'=>'{"has-error": formName.billing_zip.$touched && formName.billing_zip.$invalid}', ))); ?> </div>
                            <div class="form-group"> <?php echo e(Form::label('first_name', getPhrase( 'State/Province' ) )); ?> <?php echo e(Form::text('billing_state', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'State/Province' ), 'title' => getPhrase('State/Province' ), 'ng-model'=>'billing_state', 'ng-class'=>'{"has-error": formName.billing_state.$touched && formName.billing_state.$invalid}', ))); ?> </div>
                            <div class="form-group"> <?php echo e(Form::label('first_name', getPhrase( 'Country' ) )); ?>

                                <?php
									$countries = array_pluck( App\Countries::where('status', '=', 'Active')->get(), 'name', 'name' );
									?> <?php echo e(Form::select('billing_country', $countries, null, ['class'=>'form-control select2', "id"=>"billing_country"])); ?> </div>
                        </div>
                        <div class="save">
