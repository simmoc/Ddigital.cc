<?php $__env->startSection('content'); ?>
 <section class="content-header">
     <div class="row">
       <div class="col-lg-12">
      <ol class="breadcrumb">
             <li><a href="<?php echo e(URL_DASHBOARD); ?>"><i class="fa fa-home"></i> Home</a></li>
             <li class="active">Coupons Dashboard</li>
         </ol>
     </div>
     </div>
</section>
      ...
      <div class="col-md-3">
           ...
           <div class="col-md-3 ">
            ...
            <i class="fa fa-plus-circle" aria-hidden="true"></i>
              ...
              <a class="card-footer text-muted" 
              href="<?php echo e(URL_COUPONS_ADD); ?>">
