...
<?php endif; ?>	  
	<div class="col-md-4 col-sm-6">
		...
		<div class="product <?php echo e($extra_class); ?>">
				...
				<div class="portfolio-hover">
					<div class="portfolio-hover-content font-reg">
						<ul class="pair-btns">
							...
							<?php endif; ?>
							<li><a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS . $product->slug); ?>" class="btn btn-view"><?php echo e(getPhrase('details')); ?></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="product-content">
				...
				<a href="<?php echo e(URL_DISPLAY_PRODUCTS_DETAILS.$product->slug); ?>" class="product-title" title="<?php echo e($product->name); ?>"> <?php echo e(getPhrase(strlen($product->name) < 24) ? getPhrase($product->name) : getPhrase(substr($product->name,0,15)).'...'); ?> </a>
	...
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	 <div class="products-button">						
						<a class="btn btn-primary" href="<?php echo e(URL_DISPLAY_PRODUCTS); ?>"><?php echo e(getPhrase('view_more')); ?></a>
					</div>
	...
	<?php endif; ?> -->
	<?php else: ?>
		<div class="col-md-4 col-sm-6"> <?php echo e(getPhrase('no_products_found')); ?>
