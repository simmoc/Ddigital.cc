        ...
        <div class="container">
          ...
          <?php echo Form::file('image', array('id'=>'image_input', 'accept'=>'.png,.jpg,.jpeg')); ?>
              ...
              <?php } } ?>
                                ...
                                <div class="form-group">
                               <?php echo e(Form::label('email', getPhrase( 'Email address' ) )); ?>
...
<?php echo e(Form::label('password', getPhrase( 'Password' ) )); ?>
                                ...
                                <div class="form-group">
<?php echo e(Form::label('confirm_password', getPhrase( 'Re-enter Password' ) )); ?>

                                    <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="<?php echo e(getPhrase( 'Re-enter Password' )); ?>">
