   	...
   	<div class="box-body  clearfix">
        ...
        <div class="row">
		<div class="col-md-6">
            <h3><b><?php echo e(getPhrase('categories')); ?></b><span class="text-red">*</span></h3>
		...
		<div class="col-md-6">
            <h3><b><?php echo e(getPhrase('licences')); ?></b> <span class="text-red">*</span></h3>
		...
		<div class="col-md-6" id="price_display_type_div">
			...
			<div class="form-group">
			 ...
			 <?php echo e(Form::select('price_display_type', array('checkbox' => getPhrase('Checkbox'), 'radio' => getPhrase('radio'), 'dropdown' => getPhrase('drop_down') ), null, ['class'=>'form-control', 'id' => 'price_type', 'data-toggle' => 'tooltip', 'required' => 'true'])); ?>
