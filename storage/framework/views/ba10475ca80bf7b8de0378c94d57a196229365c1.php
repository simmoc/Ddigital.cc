	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				  <h2>TOTAL CART</h2>
				 <div class="total">
					  <p class="fee">PRODUCTS PRICE : <span><?php echo e(currency( Cart::instance('default')->subtotal() )); ?></span></p>
					  <p class="fee">Tax : <span><?php echo e(currency( Cart::instance('default')->tax() )); ?></span></p>
					  <p class="fee">SUPPORT FEE : <span><?php echo e(currency($payment_data->licence_price)); ?></span></p>
					  <p class="fee">COUPON CODE OFF : <span>- <?php echo e(currency($payment_data->discount_amount)); ?></span></p>
					  <?php $cart_total = $parsed = floatval(preg_replace('/[^\d.]/', '', Cart::total()));?>
					  <p class="fees">TOTAL PRICE : <span><?php echo e(currency( $cart_total+ $payment_data->licence_price - $payment_data->discount_amount )); ?></span></p>
