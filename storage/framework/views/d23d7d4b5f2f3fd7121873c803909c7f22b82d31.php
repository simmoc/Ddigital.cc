...
<section class="search-bg">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="hero-title"> <?php echo e(getPhrase('home_page_banner_heading')); ?></h1>
				...
				<div class="sign">					
						...
						<div class="input-group">
							...
							?>
							<div class="dropdown">
							<input type="text" name="title" id="title" class="form-control" placeholder="<?php echo e(getPhrase('Search BY Product')); ?>" data-toggle="dropdown">								
							...
							<div class="input-group-addon">
								<span class="select">
									<select class="btn btn-select select2" name="category">select
										...
										<?php $__currentLoopData = $categories->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           ...
                                           <option value="">Category</option>
											...
											<option value="<?php echo e($subcat->slug); ?>"><?php echo e($subcat->title); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</optgroup>
			...
			<div class="col-md-7 col-sm-6">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="main">
							<div class="counter">
								<h6><?php echo e(getPhrase('This offer expires on')); ?></h6>
...
<a href="<?php echo e(URL_OFFERS_VIEW_ALL); ?>" class="btn btn-primary">More Offers</a>
</div>
	...
	<div class="container">
		<div class="">
			<div class="row cs-row">
				<div class="col-md-12">
					<h2 class="heading heading-center"><?php echo e(getPhrase('PRODUCTS', 'upper')); ?></h2>
					<div class="products">
						<div class="tabs">
				...
				<?php echo $__env->make('displayproducts.products', array('products' => $products, 'nopagelinks' => 'nopagelinks', 'type' => 'related'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
				<div class="col-lg-12">
					<div class="products-button">						
						<a class="btn btn-primary" href="<?php echo e(URL_DISPLAY_PRODUCTS); ?>"><?php echo e(getPhrase('SEE ALL PRODUCTS', 'upper')); ?></a>
					</div>
				</div>
...
<?php echo $__env->make('displayproducts.products-view', array('products' => $category_products), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!--/section-4 CATEGORIES-->
