   	...
   	<div class="box-body">
		...
		<div class="col-md-6">                
			<div class="form-group">			
			 ...
			 <?php echo e(Form::text('name', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Product Name',
		...
		<div class="col-md-6">                
			<div class="form-group">			
			 ...
			 <?php echo e(Form::text('product_format', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Product format',
		...
		<div class="col-md-6">
			...
			?>			
			<?php echo e(Form::select('categories[]', $categories, $selected_cats, ['data-toggle' => 'tooltip', 'title' => getPhrase('Please select categorie(s)'), 'class' => 'form-control select2', 'multiple' => 'multiple',])); ?>
		...
		<div class="col-md-6">
			...
			?>			
			<?php echo e(Form::select('licences[]', $licences, $selected_cats, ['data-toggle' => 'tooltip', 'title' => getPhrase('Please select licences(s)'), 'class' => 'form-control select2', 'multiple' => 'multiple', 'placeholder' => ''])); ?>
		...
		<div class="col-md-6">							
            <h3><b><?php echo e(getPhrase('Price Settings')); ?></b></h3>
			<?php 
			$price_types = array(
				...
				<table class="widefat digi_repeatable_table" width="100%" cellpadding="0" cellspacing="0">
					<thead>
						<tr>
							...
							<th><?php echo e(getPhrase('Option Name')); ?></th>
					...
					<tbody>					
						...
						<!--	<td class="submit" colspan="4" style="float: none; clear:both; background:#fff;">
								<button class="button-secondary digi_add_repeatable" style="margin: 6px 0;"><?php echo e(getPhrase('Add New Price')); ?></button>
							</td>-->
						</tr>
					</tbody>
				</table>
		...
		<div class="col-md-12" id="downloadfiles_options_div">
			<div id="digi_file_fields" class="digi_meta_table_wrap">
				<table class="widefat digi_repeatable_table" width="100%" cellpadding="0" cellspacing="0">
					<thead>
						<tr>
							<th style="width: 20%"><?php echo e(getPhrase('File Name')); ?></th>
							<th><?php echo e(getPhrase('Type')); ?></th>
							<th><?php echo e(getPhrase('File URL')); ?></th>
							<th class="pricing" style="width: 20%;"><?php echo e(getPhrase('Price Assignment')); ?>
					...
					<tbody>						
						...
						<!--<tr>
							<td class="submit" colspan="4" style="float: none; clear:both; background: #fff;">
								 <button class="button-secondary digi_add_repeatable" style="margin: 6px 0 10px;"><?php echo e(getPhrase('Add New File')); ?></button> 
		...
		<div class="col-md-6">                
			<div class="form-group">
			 <?php echo e(Form::label('demo_link', getPhrase( 'Demo Link' ) )); ?>

			 <?php echo e(Form::text('demo_link', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase('Demo Link Eg: http://site.com'), 'data-toggle' => 'tooltip'))); ?>

			</div>
		</div>
		<div class="col-md-6">                
			<div class="form-group">
			 <?php echo e(Form::label('image', getPhrase( 'Preview image' ) )); ?>
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<?php echo e(Form::textarea('licence_of_use', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'licence_of_use for the product' ), 'rows'=>'4', 'data-toggle' => 'tooltip', 'title' => getPhrase('licence_of_use for the product')))); ?>

			</div>
			<div class="form-group">
				<?php echo e(Form::label('technical_info', getPhrase( 'technical_info' ) )); ?>               
				<?php echo e(Form::textarea('technical_info', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'technical_info for the product' ), 'rows'=>'4', 'data-toggle' => 'tooltip', 'title' => getPhrase('technical_info for the product')))); ?>

			</div>
			<div class="form-group">
				<?php echo e(Form::label('description', getPhrase( 'description' ) )); ?>               
				<?php echo e(Form::textarea('description', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'Description for the product' ), 'rows'=>'4', 'data-toggle' => 'tooltip', 'title' => getPhrase('Description for the product')))); ?>

			</div>
			<div class="form-group">
				<?php echo e(Form::label('download_notes', getPhrase( 'download_notes' ) )); ?>               
				<?php echo e(Form::textarea('download_notes', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'Download notes for the product' ), 'rows'=>'4', 'data-toggle' => 'tooltip', 'title' => getPhrase('Download notes for the product')))); ?>
			...
			<div class="form-group">
			 ...
			 <?php echo e(Form::text('meta_tag_title', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase( 'Title Meta Tag' ), 'data-toggle' => 'tooltip', 'title' => getPhrase('Product SEO Title')))); ?>
			...
			<div class="col-md-6">
				...
				<?php echo e(Form::textarea('meta_tag_description', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'Description Meta Tag' ), 'rows'=>'4', 'data-toggle' => 'tooltip'))); ?>
			...
			<div class="col-md-6">
				...
				<?php echo e(Form::textarea('meta_tag_keywords', $value = null, $attributes = array('class'=>'form-control ckeditor', 'placeholder' => getPhrase( 'Kewords Meta Tags separated with comma(,)' ), 'rows'=>'4', 'data-toggle' => 'tooltip'))); ?>
