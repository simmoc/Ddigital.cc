    ...
    <section class="content-header">
     ...
     <div class="col-lg-12">
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo e(getPhrase('List')); ?></li>
      </ol>
        </div>
        </div>
    </section>
            ...
            <div class="box-header">
                     ...
                     <div class="panel-heading">
                        ...
                        <div class="pull-right messages-buttons">
                            <a href="<?php echo e(URL_PAGES_ADD); ?>" class="btn btn-primary pull-right"><?php echo e(getPhrase('Add')); ?></a>
...
<?php echo $__env->make('common.datatables',array('route'=>URL_PAGES_LIST,'route_as_url'=>TRUE), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
