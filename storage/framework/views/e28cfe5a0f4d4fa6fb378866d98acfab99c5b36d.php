...
<section class="register">
  <div class="container">
	<div class="row">
       <div class="col-md-8 col-md-offset-2 col-sm-6 col-sm-offset-3 col-xs-12 digi-download-register">
				<h2 class="heading heading-center"><?php echo e(getPhrase('great_join_with_us')); ?></h2>
				...
				<form class="form-horizontal" role="form" method="POST" action="<?php echo e(URL_USERS_REGISTER); ?>" id="formName">
					...
					<div class="terms">
						 <?php
                          ...
                          $terms = getSetting('terms_and_conditions','site_settings');   

                          $privacy = getSetting('privacy_policy','site_settings');   

						?>
						<?php if($terms!=''): ?>
						<a href="<?php echo e($terms); ?>" target="_blank"><?php echo e(getPhrase('terms_and_conditions')); ?></a> <span> <?php echo e(getPhrase('and')); ?> </span>
						<?php else: ?>
						<a href=""><?php echo e(getPhrase('terms_and_conditions')); ?></a> <span> <?php echo e(getPhrase('and')); ?> </span>
						<?php endif; ?>
						<?php if($terms!=''): ?>
						<a href="<?php echo e($privacy); ?>" target="_blank"><?php echo e(getPhrase('privacy_policy')); ?></a>
						<?php else: ?>
						<a href=""><?php echo e(getPhrase('privacy_policy')); ?></a>
						<?php endif; ?>
					</div>
					<div class="reg-btn">
